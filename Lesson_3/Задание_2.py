...
query_1 = merged_2.query("registration_date.dt.year >= 2022 and order_date.dt.year == 2023 and total > 30000")
print(query_1[['first_name','last_name', 'order_id']])
print(f"Количество продаж: {len(query_1)}")